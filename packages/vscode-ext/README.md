...
1. **OCaml Source** (`src/vscode_mlisp.ml`)
2. **dune build** - Compiles OCaml to JavaScript bytecode (`_build/.../bc.js`, ~2.6 MB)
3. **esbuild --bundle** - Bundles and minifies (`dist/vscode_mlisp.bc.js`, ~417 KB)
4. **vsce package** - Creates VSIX package (`mlisp-vscode-0.1.0.vsix`, ~135 KB)
